      ...
      <main id="conteudo" tabIndex={-1}>
        ...
        <section id="inicio" className="hero section-width" aria-labelledby="hero-title">
          <div className="hero-copy">
            ...
            <h1 id="hero-title">Pode algo bom<br />vir do <span className="outlined-word">Amazonas?</span></h1>
          ...
          <div className="hero-picture-wrap">
            ...
            <figure className="hero-image">
              <Image src="/images/amazonas.jpg" alt="Vista aérea de um rio entre a floresta amazônica, próximo a Manaus." fill priority sizes="(max-width: 760px) 100vw, 47vw" />
